...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('libs/tag/jquery.tag-editor.css')?>">
    ...
    <script src="<?php echo base_url('libs/tag/jquery.tag-editor.min.js')?>"></script>
    <script src="<?php echo base_url('libs/tag/jquery.caret.min.js')?>"></script>
